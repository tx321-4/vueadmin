...
<div>
  <section>
    ...
    <!-- 列表 -->
    <el-table :data="users" :header-row-style="{background:' #eef1f6',color:' #1f2d3d'}"  highlight-current-row v-loading="listLoading" @selection-change="selsChange" style="100%">
      ...
      <el-form :model="editForm" label-width="80px" :rules="editFormRules" ref="editForm">
        ...
        <el-form-item label="性别">
          <el-radio-group v-model="editForm.sex">
            <el-radio class="raido" :label="1">男</el-radio>
